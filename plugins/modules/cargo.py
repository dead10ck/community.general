...
__metaclass__ = type
package_type = dict[str, str | dict[str, str]]
...
class Cargo:
    ...
    def get_latest_published_version(self, package: package_type) -> package_type:
        ...
        data, _ = self._exec(cmd, run_in_check_mode=True, check_rc=True)
    ...
    def get_source_directory_version(
        ...
        data, _ = self._exec(cmd, True, False)
...
def main():
    arg_spec = dict(
        ...
        bin=dict(default=None, type="str"),
